...
"""
FastAPI application for the Factory Env Environment.

This module creates an HTTP server that exposes the FactoryEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m factory_env.server.app
    ...
    multiple workers:
        uvicorn factory_env.server.app:app --workers 4
    """
    import uvicorn
